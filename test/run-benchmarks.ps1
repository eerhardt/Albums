...
Run "crank $commonArgs --scenario albums-net-alpine --json $testResultsDir\net-pt-r2r-sf-com-serverGC.json --property platform=net-pt-r2r-sf-com-serverGC --application.buildArguments BUILD_ARGS=-p:OptimalCoreClr=true --application.buildArguments SERVER_GC=true"
Run "crank $commonArgs --scenario albums-net-alpine --json $testResultsDir\net-pt-r2r-sf-com-workstationGC.json --property platform=net-pt-r2r-sf-com-workstationGC --application.buildArguments BUILD_ARGS=-p:OptimalCoreClr=true --application.buildArguments SERVER_GC=false"
